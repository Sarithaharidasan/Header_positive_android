...
public class Generic_functions {
	...
	public static void waited(int time) {
		try {
			Thread.sleep(time);
	...
	/* Click operation for a particular fieldname that is passing to this function through finding locator value of fieldname using OR_reader function*/
	 ...
	 /* Click operation for a particular fieldname that is passing to this function through finding locator value of fieldname using OR_reader function*/
	 public static void clickclass(String fieldname) throws IOException {
		
		 driver.findElementByClassName(OR_reader("Object_Locator",fieldname )).click();
